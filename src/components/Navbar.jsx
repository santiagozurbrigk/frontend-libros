    ...
    <nav className="bg-white/95 backdrop-blur-sm shadow-md border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Botón Carrito en móvil - siempre visible */}
          <div className="md:hidden flex items-center gap-3">
            <Link
              to="/carrito"
              className="relative text-slate-700 hover:text-blue-600 transition-colors duration-200 p-2 rounded-lg hover:bg-blue-50"
            >
            ...
            <button
              onClick={toggleMenu}
              className="text-slate-700 hover:text-blue-600 transition-colors duration-200 p-2 rounded-lg hover:bg-blue-50"
        ...
        >
          <div className="py-4 space-y-2 border-t border-slate-200">
            ...
            <button
              ...
              className="w-full text-left text-slate-700 hover:text-red-600 font-medium transition-colors duration-200 px-4 py-3 rounded-lg hover:bg-red-50 flex items-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
